...
Oregon Transportation Expenditures (2022–2024)	SQL, Power BI	Cleaned and analysed 37,000+ rows of government expenditure data from Oregon's Department of Transportation across 3 fiscal years. Identified data quality issues, standardised formats, and built an interactive Power BI dashboard.
...
Dataset Information
Source: data.gov — Oregon Agency Expenditures Multi-Year Report
...
Agency Program Related Services — $2.30 Billion
Professional Services (Non-IT) — $813 Million
Distribution to Other Governments — $550 Million
Top vendor states by spend:

Oregon (OR) — $3.99 Billion
Washington (WA) — $486 Million
California (CA) — $303 Million
Power BI Dashboard
...
About the Data
All datasets used in this portfolio are sourced from publicly available government data at data.gov. No sensitive or private data is used.

PowerBI_Dashboard_Documentation.docx
